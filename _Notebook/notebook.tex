...
\DeclareTextFontCommand{\tmf}{\myfont}
...
\pagestyle{fancy}
\fancyhead[L]{\sout{Stanford} University \tmf{of rochester}}
\fancyhead[R]{\thepage}
\fancyfoot[C]{}
...
\title{\vspace{-4ex}\Large{\sout {Stanford} $\underbrace{\textrm{University}}_{\tmf{of rochester}}$ ICPC Team Notebook (2016-17-18)}}
\author{}
\date{}
